...
public class Ppal {
    ...
    public static void main(String[] args) {
        ...
        //10 El cliente c1 ('Francisco') alquila la película p1: 'El Señor de los Anillos' y p2:'The Hobbit' desde el v            
        ...
        //10 El cliente c1 ('Francisco') alquila el juego j1:'Simpson Game' desde el v            
        v.alquilarProducto(c1, j1); //Francisco - Simpson Game
        //11 Mostrar el número de clientes de VideoClub v
        int numClientesVideoMax=v.numClientes();
        System.out.println("El videoClub "+v.getNombre()+" tiene "+numClientesVideoMax+" clientes");
        //12 Muestra por pantalla los productos alquilador por el cliente: Francisco c1
        ...
        for(Producto t: c1.getProductosAlquilados())
